...
import org.d3if3111.assesmentmobpro.ui.screen.DetailScreen
...
fun SetupNavGraph(navController: NavHostController = rememberNavController()) {
    NavHost(
        ...
        composable(
            ...
            arguments = listOf(
                navArgument(KEY_ID_UANG) {type = NavType.LongType }
            )
        ) {
            navBackStackEntry ->
            val id = navBackStackEntry.arguments?.getLong(KEY_ID_UANG)
